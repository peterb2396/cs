...
public class StringHelper {
	 ...
	 */
	private static final String path = StringHelper.class.getProtectionDomain().getCodeSource().getLocation().getPath() + StringHelper.class.getPackage().getName() + "/bag.txt";
